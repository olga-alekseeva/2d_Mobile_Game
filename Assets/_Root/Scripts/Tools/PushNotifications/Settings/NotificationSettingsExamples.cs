...
{
    [CreateAssetMenu(fileName = nameof(NotificationSettingsExamples),
        menuName = "Settings/Notifications/" + nameof(NotificationSettingsExamples))]
    internal sealed class NotificationSettingsExamples : ScriptableObject
    {
